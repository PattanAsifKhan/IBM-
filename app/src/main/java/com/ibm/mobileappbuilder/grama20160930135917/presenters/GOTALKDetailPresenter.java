...
public class GOTALKDetailPresenter extends BasePresenter implements DetailCrudPresenter<AsifDSItem>,
      Datasource.Listener<AsifDSItem> {

    private final CrudDatasource<AsifDSItem> datasource;
    private final DetailView view;

    public GOTALKDetailPresenter(CrudDatasource<AsifDSItem> datasource, DetailView view){
