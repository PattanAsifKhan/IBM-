...
import com.ibm.mobileappbuilder.grama20160930135917.presenters.LOANPresenter;
...
/**
 * "LOANFragment" listing
 */
public class LOANFragment extends ListGridFragment<AsifDSItem> implements CrudListView<AsifDSItem> {

    private CrudDatasource<AsifDSItem> datasource;


    public static LOANFragment newInstance(Bundle args) {
        LOANFragment fr = new LOANFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setPresenter(new LOANPresenter(
